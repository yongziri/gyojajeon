...
const CITIZENS_BY_CASE = {
  ...
  // ══════════════════════════════════════════════════════════
  //  사건 0 — UN 본부 인트로 (튜토리얼)
  //  · 시민 NPC 1명 (한센 본인) — 짧은 객관식으로 분석 단계 체험
  ...
  intro: [
    {
      ...
      sprite: 'tiny_dungeon',
      frame: 84,
      // portrait_hansen이 있으면 자동 사용. 없으면 도트로 fallback.
      portrait: 'portrait_hansen',
      x: 430, y: 250,   // 사무실 가운데
      intro: [
        '잘 왔네, 조사관. 단서를 모았으니 한 가지만 물어보지.',
        '실제 현장에서도 시민들이 자네에게 이렇게 묻게 될 거야.',
        '한 가지만 답해 보게.',
      ],
      quiz: {
        question: '세계 시민으로서 우리가 멀리 있는 분쟁과 연결되어 있다는 것을 가장 잘 보여주는 것은?',
        hint: '책상 위 임무서나 세계지도 단서를 떠올려 보세요.',
        choices: [
          { text: '내가 입는 옷 한 벌의 원료가 멀리서 온다는 사실', correct: true,
            feedback: '맞아. 그게 \"연결(Connect)\"의 시작이지.' },
          { text: '뉴스에서 가끔 들리는 단어들', correct: false,
            feedback: '그건 너무 멀리 있는 이야기지. 우리 일상의 연결을 봐야 해.' },
          { text: '학교 시험에 가끔 나오는 주제', correct: false,
            feedback: '아니, 시험을 위한 게 아니라 진짜 우리 삶의 일이라네.' },
        ],
        reward: {
