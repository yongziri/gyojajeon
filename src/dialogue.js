...
const STORIES = {
  intro: {
    ...
    meaning: {
      speaker: "한센",
      text: "우리는 P.E.A.C.E. — 다섯 단계로 사고를 하게 된다. 이 사고는 인식-관찰-성찰-실천 네 단계를 통해 자연스럽게 나타날걸세.",
      next: "peace_p"
    },
    peace_p: {
      speaker: "한센",
    ...
    mission: {
      speaker: "한센",
      text: "자네 임무는 세 가지일세 — ① 사라진 바다(아랄해), ② 깨어진 평화(우크라이나), ③ 오래된 갈등(팔레스타인). 각 현장에서 인식-관찰-성찰-실천 4단계를 적용하고 P.E.A.C.E. 5단계의 사고를 익히게.",
      next: "encourage"
    },
    encourage: {
      speaker: "한센",
  ...
  ukraine: {
    ...
    globalFood: {
      speaker: "카테리나",
      text: "조사관님이 오신 한국의 빵 값이 두 배가 됐다고 해요. 우리나라랑 한국이랑 먼데... 우리의 식사가 이렇게 연결되어 있었어요.",
      next: "q3"
    },
    q3: {
      speaker: "카테리나",
      text: "그 밖에도 전 세계의 빵·기름값이 올랐다고 들었어요. 전쟁은 정말 멀리 있는 일일까요?",
      choices: [
        {
    ...
    energy: {
      speaker: "카테리나",
      text: "에너지도 마찬가지예요. 유럽은 러시아 가스에 의존했던 것을 후회하고 있다고 해요.",
      next: "peaceEd"
    },
    peaceEd: {
      speaker: "카테리나",
      text: "제 꿈은 도덕 선생님이 되는 거예요. 어릴 때부터 다른 사람들과 대화하고 협력하는 법을 가르치고 싶어요. 대화가 전쟁을 막는 진짜 무기래요.",
      next: "q4"
    },
    q4: {
      speaker: "카테리나",
      ...
      choices: [
        {
          label: "우크라이나의 아픔과 평화의 중요성을 알리겠다",
          love: 5,
          next: "peaceEnd"
        },
        {
  ...
  palestine: {
    start: {
      speaker: "카림",
      text: "UN 조사관님! 여기에요. 저는 카림입니다! 바로 이 곳 가자에서 태어난 토박이랍니다.",
      next: "q1"
    },
    q1: {
      speaker: "카림",
      text: "저희는 오랫동안 폭격 소리와 함께 살아왔어요. 우리 학교도 작년에 무너졌고, 친구 몇 명은 다시 못 만났어요.",
      next: "school"
    },
    school: {
      speaker: "카림",
      text: "UN이 운영하는 학교(UNRWA)에서 천막을 치고 수업해요. 정말 열악한 환경이지만 그래도 우린 매일 가요.",
      next: "origin"
    },
    origin: {
      speaker: "카림",
      text: "이 땅에는 유대인·기독교인·무슬림이 천 년 넘게 같이 살았어요. 어느 한 쪽의 잘못이라고 말하기 어려운 갈등이에요.",
      next: "olive"
    },
    olive: {
      speaker: "카림",
      text: "할아버지 농장엔 천 년 된 올리브 나무가 있었어요. 군인들이 와서 군사 시설을 설치한다고 작년에 베어 버렸어요. 할아버지는 탄식하셨죠.",
      next: "q3"
    },
    q3: {
      speaker: "카림",
      text: "조사관님, 멀리 사는 사람들에게는 이게 그냥 뉴스 한 줄이겠죠. 그래도 저희와 함께 해주실거라고 믿어요.",
      choices: [
        {
          label: "그래. 이번에도 열심히 조사해볼게.",
          love: 3,
          next: "aid"
        },
        {
    ...
    aid: {
      speaker: "카림",
      text: "전 세계의 구호물품은 매일 와요. 하지만 그 물품이 오려면 수십 개의 허가 문서가 필요해요. 생존을 위한 한 끼 식사가 외교 문서 위에 놓여요.",
      next: "peaceEd"
    },
    peaceEd: {
      speaker: "카림",
      text: "제 친구 중엔 유대인도 있어요. SNS로 만났죠. 같은 노래를 듣고, 같은 만화를 봐요. 어른들이 모르는 화해의 모습이 우리한텐 이미 있어요.",
      next: "q4"
    },
    q4: {
      speaker: "카림",
